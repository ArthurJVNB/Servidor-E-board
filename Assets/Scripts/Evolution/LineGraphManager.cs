...
public class LineGraphManager : MonoBehaviour {
	...
	IEnumerator BarGraphBlue(GraphData[] gd,float gap)
	{
		...
		while(dataCount < gd.Length)
		{
			...
			lineRenderer.startColor = new Color(63 / 255f, 61 / 255f, 86 / 255f);
            lineRenderer.endColor = new Color(63 / 255f, 61 / 255f, 86 / 255f);
            ...
            GameObject circleGameObject = new GameObject("circle", typeof(SpriteRenderer));
            circleGameObject.GetComponent<SpriteRenderer>().sprite = circleSprite;
            circleGameObject.GetComponent<SpriteRenderer>().color = new Color(63 / 255f, 61 / 255f, 86 / 255f);
            GameObject pointered = Instantiate(circleGameObject, endpoint, circleGameObject.transform.rotation) as GameObject;
            pointered.transform.localScale = new Vector3(0.4f, 0.4f);
